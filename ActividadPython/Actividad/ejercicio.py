...
def numerosCuriosos():
    print("---------------------------------------------------------------------")
    n = int(input("Ingrese el número de números curiosos que desea calcular: "))
    print("---------------------------------------------------------------------")
    resultado = numeros_curiosos(n)
    print("Los primeros", n, "números curiosos son:", resultado)
